...
class AlarmListViewController: UITableViewController{
   ...
   // var alarmDelegate: AlarmApplicationDelegate = AppDelegate()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        sw.addTarget(self, action: #selector(AlarmListViewController.switchTapped(_:)), for: UIControlEvents.valueChanged)
        if alarm.enabled {
    ...
    @IBAction func unwindToAddressList(segue:UIStoryboardSegue)
    {
        isEditing = false
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let addEditController = dist.topViewController as! AlarmEditViewController
